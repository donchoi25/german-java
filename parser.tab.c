...
static const char *const yytname[] =
{
  ...
  "ID", "INTLIT", "STRINGLIT", "CHARLIT", "$accept", "program",
  "class-decl", "decl-in-class", YY_NULLPTR
};
#endif
